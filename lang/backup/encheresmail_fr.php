...
'email_asso_enchere_gagne_objet_message' => 'Bonne nouvelle ! L’objet « @titre_article@ (@id_objet@) » a été vendu au profit de votre projet « @titre_rubrique@ », pour un montant de « @montant_mise@ » @devise@. ',
...
'email_courrier_velo' => 'Vous désirez être livré chez vous ? Utilisez la bicyclette de Dioxyde de Gambette ! Le Kidonateur qui vend cet objet habite Bruxelles et vous suggère d’utiliser ce moyen de livraison écologique. Dans ce cas, l’acheteur paye les frais de livraison (livraison standard : 5 @devise@) directement au livreur.', 
...
'email_enchere_gagnee_message_specifique_email' => '- Payer le montant de @montant_mise@ @devise@ sur le compte @compte_bancaire_asso@ de @nom_asso@  - Adresse : @adresse_asso@. N’oubliez pas de mentionner « @communication_virement@ - @titre_article@ - @id_objet@ » en communication.
...
'email_enchere_gagnee_message_specifique_frais_transport_posteouvenir' => 'Payer les frais de transport (dans le cas où vous ne souhaitez pas enlever l’objet chez le Kidonateur) qui s’élèvent à @prix_transport@ @devise@ sur le compte @compte_bancaire_kidonateur@ du kidonateur @nom_kidonateur@.  N’oubliez pas de préciser  «  transport: @id_objet@ » (numéro de l’objet) en communication.@message_paypal_kidonateur@ ',
...
'email_kidonateur_enchere_gagnee_objet_message' => 'Félicitations, votre objet « @titre_article@ (@id_objet@) » a été vendu pour un montant de @montant_mise@ @devise@ !',
...
'email_mise_vente_objet_message_remise' => 'Si cet objet n’a pas trouvé d’acquéreur endéans la période choisie, vous pourrez cliquer sur «remettre en vente», sans aucun frais bien entendu.', 
...
'email_objet_recu_kidonateur_message_soutien' => 'Grâce à cette vente,  vous avez soutenu le projet @titre_rubrique@ mené par  @nom_asso@ qui a donc reçu un don de @montant_mise@ @devise@. ',
